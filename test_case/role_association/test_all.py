...
class Test_all(object):
    ...
    @pytest.mark.parametrize("inData",ExcelData("ED_"))
    def test_ED(self,all_token,inData):
        """essential data（基础数据）"""
    ...
    @pytest.mark.parametrize("inData",ExcelData("PD_"))
    def test_PD(self,all_token,inData):
